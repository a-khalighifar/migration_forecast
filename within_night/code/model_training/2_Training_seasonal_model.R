...
# Define directories for loading datasets (train.dir) and saving models (model.dir)
train.dir <- file.path("data/04_trainingData", paste0(start_hour, "_", end_hour, "/"))
model.dir <- file.path("data/05_savedModels", paste0(start_hour, "_", end_hour, "/"))
results.dir <- file.path("data/06_Model_performance", paste0(start_hour, "_", end_hour, "/"))
# create directories if they don't exist
dir.create(train.dir, recursive = TRUE, showWarnings = FALSE)
