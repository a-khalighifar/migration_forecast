...
train.dir <- '/Volumes/Mikko2/csu/phd/projects/forecast/Forecast_chapter/Data/04_trainingData/8-10/'
model.dir <- '/Volumes/Mikko2/csu/phd/projects/forecast/Forecast_chapter/Data/05_savedModels/8-10/'
results.dir <- '/Volumes/Mikko2/csu/phd/projects/forecast/Forecast_chapter/Data/06_Model_performance/8-10/'
...
for (turn in 1:length(num.trainings)) {
  ...
  training.cols <- colnames(trainset.spring)[-c(1:3, 125, 127, 134:140, 143, 145, 156)]
